...
export default function Footer() {
  return (
    <div className="fixed bottom-0 right-0 left-0 z-10 h-16 md:h-20 bg-blue-600">
        <div className="h-full grid place-content-center ">
            <div className="flex space-x-10">
                ...
                <div className="flex space-x-6 items-center font-bold">
                    <button className="bg-inherit text-white border border-white rounded-2xl py-1 px-3 hover:bg-blue-700 transition-all duration-200">Log In</button>
