...
export default function Register({ setDetails, details }) {
  return (
    <div className="hidden lg:block max-w-sm">
        <div className="m-6 rounded-2xl border-[1px] p-3 py-6">
            ...
            <ul className="signup space-y-4 mt-4">
                ...
                <li><button onClick={()=> setDetails({...details, newMember: false, isModalOpen: true}) } className="rounded-3xl w-full text-sm text-center border-[2px] p-2 hover:bg-gray-200 dark:hover:bg-slate-500 transition-all duration-200">Create account</button> </li>
